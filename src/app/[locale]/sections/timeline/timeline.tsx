    ...
    return (
        ...
        >
            <div className="absolute top-0 left-0 right-0 pt-10 md:pt-12 flex flex-col items-center z-10 gap-3 pointer-events-none">
                ...
                <p className="text-lg md:text-xl text-center px-6 text-black_primary/60 max-w-3xl">
                    {t('subtitle')}
                </p>
            </div>
            ...
            >
                <div className="relative px-6 py-10 min-w-max mx-auto">
                    <div
                        className="pointer-events-none absolute left-0 right-0 h-[3px] rounded-full bg-primary/70"
                        style={{
                            top: `${AXIS_TOP_PX}px`,
                            WebkitMaskImage:
